...
define i32 @main() {
entry:
  %v11 = call i8* @malloc(i64 20)
  %v12 = bitcast i8* %v11 to i32*
  store i32 3, i32* %v12
  %v13 = getelementptr i8, i8* %v11, i32 4
  %v14 = bitcast i8* %v13 to i32*
  store i32 3, i32* %v14
  %v15 = getelementptr i8, i8* %v11, i32 8
  %v16 = bitcast i8* %v15 to i32*
  store i32 10, i32* %v16
  %v17 = getelementptr i8, i8* %v11, i32 12
  %v18 = bitcast i8* %v17 to i32*
  store i32 20, i32* %v18
  %v19 = getelementptr i8, i8* %v11, i32 16
  %v20 = bitcast i8* %v19 to i32*
  store i32 30, i32* %v20
  %v10 = bitcast i8* %v11 to i8*
  %v9 = alloca i8*
  store i8* %v10, i8** %v9
  %v23 = load i8*, i8** %v9
  %v24 = call i8* @__rt_list_push(i8* %v23, i32 40)
  %v22 = bitcast i8* %v24 to i8*
  %v21 = alloca i8*
  store i8* %v22, i8** %v21
  %v25 = load i8*, i8** %v21
  %v26 = call i32 @__rt_list_len(i8* %v25)
  call void @std__print_int(i32 %v26)
  %v27 = load i8*, i8** %v21
  %v28 = mul i32 3, 4
  %v29 = add i32 %v28, 8
  %v30 = getelementptr i8, i8* %v27, i32 %v29
  %v31 = bitcast i8* %v30 to i32*
  %v32 = load i32, i32* %v31
  call void @std__print_int(i32 %v32)
  %v34 = load i8*, i8** %v21
  %v35 = call i32 @__rt_list_pop(i8* %v34)
  %v33 = alloca i32
  store i32 %v35, i32* %v33
  %v36 = load i32, i32* %v33
  call void @std__print_int(i32 %v36)
  %v37 = load i8*, i8** %v21
  %v38 = call i32 @__rt_list_len(i8* %v37)
  call void @std__print_int(i32 %v38)
  ret i32 0
}
...
entry:
  ...
  %v39 = load i32, i32* %arg0_alloca
  call void @__rt_print_int(i32 %v39)
  ret void
}
