...
@.str15 = private unnamed_addr constant [14 x i8] c"\48\65\6C\6C\6F\2C\20\57\6F\72\6C\64\21\00"
@.str17 = private unnamed_addr constant [10 x i8] c"\63\6F\6E\74\61\69\6E\73\3A\00"
@.str18 = private unnamed_addr constant [4 x i8] c"\25\73\0A\00"
@.str22 = private unnamed_addr constant [6 x i8] c"\57\6F\72\6C\64\00"
...
entry:
  ...
  %v11 = load i8*, i8** %arg1_alloca
  %v12 = call i32 @__rt_contains(i8* %v10, i8* %v11)
  ret i32 %v12
}

define i32 @main() {
entry:
  %v14 = getelementptr [14 x i8], [14 x i8]* @.str15, i32 0, i32 0
  %v13 = alloca i8*
  store i8* %v14, i8** %v13
  %v16 = getelementptr [10 x i8], [10 x i8]* @.str17, i32 0, i32 0
  %v19 = getelementptr [4 x i8], [4 x i8]* @.str18, i32 0, i32 0
  call i32 (i8*, ...) @printf(i8* %v19, i8* %v16)
  %v20 = load i8*, i8** %v13
  %v21 = getelementptr [6 x i8], [6 x i8]* @.str22, i32 0, i32 0
  %v23 = call i32 @std__contains(i8* %v20, i8* %v21)
  call void @std__print_int(i32 %v23)
  ret i32 0
}
...
entry:
  ...
  %v24 = load i32, i32* %arg0_alloca
  call void @__rt_print_int(i32 %v24)
  ret void
}
